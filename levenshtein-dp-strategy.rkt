...
(define/contract (levenshtein-dp-strategy #:delta-del   [delta-del 1.0]
                                          #:delta-ins   [delta-ins 1.0]
  ...
  (->* ()
       ...
       dp-strategy/c)
  (lambda (length-a length-b prev-del-score prev-ins-score prev-match-score mtch)
    (cond
