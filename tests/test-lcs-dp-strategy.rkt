...
(module+ test
  ...
  (check-dist "abba" "karo" 3.0) ;; levenshtein: 4.0
  (check-dist "abba" "mama" 2.0) ;; levenshtein: 3.0
  (check-dist "abba" "oma" 3.0)
  (check-dist "abba" "baba" 1.0) ;; levenshtein: 2.0
  (check-dist "abba" "yeye" 4.0)
  (check-dist "abba" "gugu" 4.0)
  (check-dist "anna" "otto" 4.0)
  (check-dist "anna" "karo" 3.0) ;; levenshtein: 4.0
  (check-dist "anna" "mama" 2.0) ;; levenshtein: 3.0
  (check-dist "anna" "oma" 3.0)
  (check-dist "anna" "baba" 2.0) ;; levenshtein: 3.0
  ...
  (check-dist "karo" "oma" 3.0) ;; levenshtein: 4.0
